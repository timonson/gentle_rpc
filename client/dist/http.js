...
function validateRpcBasis(data1) {
  return (data1 === null || data1 === void 0 ? void 0 : data1.jsonrpc) === "2.0" && (typeof data1.id === "number" || typeof data1.id === "string" || data1.id === null);
}
...
function validateRpcFailure(data1) {
  ...
  return typeof (data1 === null || data1 === void 0 ? void 0 : (_data1$error = data1.error) === null || _data1$error === void 0 ? void 0 : _data1$error.code) === "number" && typeof data1.error.message === "string";
}

function validateResponse(data1) {
  if (validateRpcBasis(data1)) {
    if (validateRpcSuccess(data1)) return data1;else if (validateRpcFailure(data1)) {
...
function send(resource, fetchInit) {
  return fetch(resource instanceof URL ? resource.href : resource, fetchInit).then(function (res) {
    if (!res.ok) {
      return Promise.reject(new RangeError("".concat(res.status, " '").concat(res.statusText, "' received instead of 200-299 range.")));
    ...
    value: function batch(batchObj) {
      ...
      return send(this.resource, _objectSpread(_objectSpread({}, this.fetchInit), {}, {
        ...
        if (rpcResponseBatch === undefined && isNotification) {
          ...
          return Array.isArray(batchObj) ? processBatchArray1(rpcResponseBatch) : processBatchObject1(rpcResponseBatch);
        } else {
